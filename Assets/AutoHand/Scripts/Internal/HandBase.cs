...
namespace Autohand {
    ...
    public class HandBase : MonoBehaviour {
        ...
        protected List<Collider> handCollidersIgnoredForced = new List<Collider>();
        ...
        public void HandIgnoreCollider(Collider collider, bool ignore) {
            if(!handCollidersIgnoredForced.Contains(collider))
            {
        ...
        public void ForceIgnoreCollision(Collider collider)
        {
            HandIgnoreCollider(collider, true);
            handCollidersIgnoredForced.Add(collider);
        }

        public void UnForceIgnoreCollision(Collider collider)
        {
            if(handCollidersIgnoredForced.Remove(collider))
            {
